const fs = require('fs');
let text = fs.readFileSync('./text1.txt');
const bitText = fs.readFileSync('./text3.txt');
const text5 = fs.readFileSync('./text5.txt');
...
const str = 'Иконов Василий Сергеевич';
const str1 = 'Иконов Василий Сергеевич'.toLowerCase().replace(regExpSimbols, '');
console.log("-----------------Задание 1 --------------")
console.log(`Длина текста = ${text.length}`);
console.log(`Энтропия по Шеннону: ${shanon(text, alfabhetRUS)}`);
console.log(`Энтропия по Хартли: ${hartley(alfabhetRUS.length)}`);
...
console.log(`Иконов Василий Сергеевич Количество информации(по Шеннону): ${vasiliyShanon(str1, text, alfabhetRUS)}`);
console.log(`Иконов Василий Сергеевич Количество информации(по Хартли): ${vasiliyHartley(str1, alfabhetRUS)}`);
console.log(`Иконов Василий Сергеевич Количество информации(в бинарном виде): ${vasiliyShanon(text5, bitText.toString(), binAlf)}`);
